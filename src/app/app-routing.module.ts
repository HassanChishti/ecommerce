...
const routes: Routes = [
  ...
  },
  {
    path: 'recovery-code',
    loadChildren: () =>
      import('./recovery-code/recovery-code.module').then(
        (m) => m.RecoveryCodePageModule
      ),
  },
  {
    path: 'new-password',
  ...
  },
  {
    path: 'helo-card',
    loadChildren: () =>
      import('./helo-card/helo-card.module').then((m) => m.HeloCardPageModule),
  },
  {
    path: 'full-profile',
    loadChildren: () =>
      import('./full-profile/full-profile.module').then(
        (m) => m.FullProfilePageModule
      ),
  },
  {
    path: 'shop',
  ...
  },
  {
    path: 'flash-sale',
    loadChildren: () =>
      import('./flash-sale/flash-sale.module').then(
        (m) => m.FlashSalePageModule
      ),
  },
  {
    path: 'clothing',
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./settings-profile/settings-profile.module').then(
  ...
  },
  {
    path: 'recieve',
    loadChildren: () =>
      import('./recieve/recieve.module').then((m) => m.RecievePageModule),
  },
  // {
  //   path: 'toast',
